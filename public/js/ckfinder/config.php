...
if(isset($_SESSION['resourceType'])) $resourceType = $_SESSION['resourceType']; else $resourceType = "Images";
if(isset($_SESSION['fileDelete'])) $fileDelete = $_SESSION['fileDelete']; else $fileDelete = false;
...
$config['ResourceType'][] = Array(
		...
		'directory' => $baseDir ,
		'maxSize' => '20M',
		'allowedExtensions' => '7z,bmp,doc,docx,gif,gz,gzip,jpeg,jpg,pdf,png,ppt,pptx,rar,rtf,tar,tgz,tif,tiff,txt,xls,xlsx,zip',
		'deniedExtensions' => '');
...
*/
$config['HideFolders'] = Array(".*", "CVS", "thumbs");
